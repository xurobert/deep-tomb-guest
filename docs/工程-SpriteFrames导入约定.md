...
| 目录 | 内容 | 尺寸 |
|------|------|------|
| `characters/hero/` | 主角地图精灵 | 32×32 px |
| `characters/enemies/` | 敌人地图精灵 | 32×32 px |
| `characters/npc/` | NPC 地图精灵 | 32×32 px |
...
|------|------|------|------|----------|--------|--------|
| 待机 (idle) | 32×32 | 4 | 6 fps | 循环 | 4 | 16 |
| 行走 (walk) | 32×32 | 6–8 | 10 fps | 循环 | 4 | 24–32 |
| 攻击 (attack) | 32×32 | 4–6 | 12 fps | 单次 | 4 | 16–24 |
| 受击 (hit) | 32×32 | 2 | 8 fps | 单次 | 1* | 2 |
...
| 状态 | 尺寸 | 帧数 | 帧率 | 播放模式 | 说明 |
|------|------|------|------|----------|------|
| 待机 (idle) | 32×32 | 2 | 4 fps | 循环 | 最小化，微动 |
| 攻击 (attack) | 32×32 | 3 | 10 fps | 单次 | 简化挥砍 |
