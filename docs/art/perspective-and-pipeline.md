...
| 资源类型 | 尺寸 | 说明 |
|----------|------|------|
| 地图瓦片 (map-tile) | 16×16 px | 整格拼接，无缝边缘 |
| 地图角色精灵 (map-sprite) | 32×32 px | 探索/战斗场景中显示 |
...
- ❌ 自由视角旋转
- ❌ 非整数缩放导致的像素模糊
- ❌ 混用不同像素密度的资源（如 32×32 精灵放在 8×8 瓦片上）
